...
7. Replace the client id and variables while leaving them in the ''
8. Add your location by replacing the CITY/COUNTRY. It should look something like this: `'Rome/Italy'`. This data is private.
